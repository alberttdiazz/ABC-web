        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-5 gap-12">
            ...
            <div className="lg:col-span-2 animate-on-scroll">
              <h2 className="section-title mb-6">{t('info_title')}</h2>
                ...
                <div className="card">
                  <div className="space-y-4">
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <a href="tel:+34932434835" className="block text-sm font-semibold text-ink hover:text-teal">93 243 48 35</a>
                        <a href="tel:+34634545308" className="block text-sm font-light text-gray hover:text-teal">634 545 308</a>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <a href="mailto:info@abccentre.es" className="text-sm font-semibold text-ink hover:text-teal">info@abccentre.es</a>
                    </div>
